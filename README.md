...
Atuar como estagiária ou desenvolvedora júnior em Tecnologia da Informação, com interesse em desenvolvimento de software, suporte técnico, implantação de sistemas, CRM, dados e infraestrutura.
...
- 🌐 Desenvolvimento de interfaces web com foco em usabilidade e organização visual
- 📈 Apoio em processos de implantação e configuração no HubSpot
- 📝 Criação e organização de documentações técnicas e playbooks
- 👤 Elaboração de documentação de ICP *(Perfil de Cliente Ideal)*
- 💬 Organização de fluxos, filtros, chats e recursos de help desk
- 🔎 Verificação de instalação e rastreamento de ferramentas em sites
- 🔗 Apoio em atividades com APIs, automações e integrações
- 📊 Organização de informações, processos e dados para suporte e relacionamento com clientes
...
Interfaces modernas, organizadas e intuitivas, com preferência por identidade visual em tons de roxo e preto.
...
- 🐱 **GitHub:** [juliane2301](https://github.com/juliane2301)
- 🌍 Mais informações também estão disponíveis no meu [portfólio online](https://julianedev.vercel.app/)
